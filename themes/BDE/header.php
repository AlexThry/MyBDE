        ...
        <a href="<?= is_front_page() ? "#body" : site_url()  ?>">
            ...
            <div class="nav-buttons">
                ...
                <?php if (is_user_logged_in()) : ?>
                    ...
                    <a href="<?php echo wp_logout_url(home_url()) ?>" class="connection-button"><span>Déconnexion <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
